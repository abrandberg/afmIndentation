...
@testset "Test readIBW                   " begin
    ...
    @test begin
        # Regression test 1
        inputVec = readIBW("sampleRealData/MOF_Mg_2_1_0009.ibw")
    ...
    @test begin
        # Regression test 3
        inputVec = readIBW("sampleRealData/MOF_Zn_2_1_0008.ibw")
    ...
    @test begin
        # Regression test 5
        inputVec = readIBW("sampleRealData/PMMA_0013.ibw")
    ...
    @test begin
        # Regression test 7
        inputVec = readIBW("sampleRealData/RH45_1_2_0001.ibw")
...
@testset "modulusfitter                  " begin
    ...
    indentSet = metaInfoExperimentalSeries("Test2", 
                                        ...
                                        "X",
                                        217.51, 
                                        "sampleRealData/LRH250_1_0001_arfun.txt",
                                        "sampleRealData/",
                                        50000)
    ...
    @test begin
        ...
        isapprox(1.8696, modulusfitter( indentSet, hp, ctrl, "MOF_Mg_2_1_0009.ibw"),rtol = 0.05)
    end
    @test begin
        hp =  hyperParameters( 2000, 1400, "Oliver-Pharr", true, 0, 0, 0.0)
        isapprox(1.9, modulusfitter( indentSet, hp, ctrl, "MOF_Mg_2_1_0009.ibw"),rtol = 0.05)
    end
    @test begin
        hp =  hyperParameters( 2000, 1400, "Feng", false, 0, 0, 0.0)
        isapprox( 1.9289, modulusfitter( indentSet, hp, ctrl, "MOF_Mg_2_1_0009.ibw"),rtol = 0.05)
    end
    @test begin
        hp =  hyperParameters( 2000, 1400, "Feng", true, 0, 0, 0.0)
        isapprox( 1.92197, modulusfitter( indentSet, hp, ctrl, "MOF_Mg_2_1_0009.ibw"), rtol = 0.05)
    end
end
